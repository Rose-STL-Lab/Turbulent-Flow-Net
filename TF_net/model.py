from model_addon import *

# # # Need this file as traditionally models were saved using torch.save(), which requires the model file as the reference.
...
# def get_pos_emb(tstep, xx_len, w=64, h=64):
#     inp_len = xx_len // 2
